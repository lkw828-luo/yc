...
def main():
    ...
    # basic config
    parser.add_argument('--is_training', type=int, default=0, help='status')#训练
    #parser.add_argument('--is_training', type=int, default=0, help='status')#预测
  ...
  #  parser.add_argument('--root_path', type=str, default='./dataset/ETT/', help='root path of the data file')
   # parser.add_argument('--data_path', type=str, default='ETTh1.csv', help='data file')
    ...
    parser.add_argument('--data_path', type=str, default='CN2.csv', help='data file')
    #parser.add_argument('--data_path', type=str, default='CN2.csv', help='data file')
    ...
    parser.add_argument('--target', type=str, default='co2', help='target feature in S or MS task')
    parser.add_argument('--freq', type=str, default='d',
                        help='freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, '
                             'b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
    parser.add_argument('--detail_freq', type=str, default='d', help='like freq, but use in predict')
